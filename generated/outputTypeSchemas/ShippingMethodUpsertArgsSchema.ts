...
import { ShippingMethodCreateInputSchema } from '../inputTypeSchemas/ShippingMethodCreateInputSchema'
import { ShippingMethodUncheckedCreateInputSchema } from '../inputTypeSchemas/ShippingMethodUncheckedCreateInputSchema'
...
export const ShippingMethodUpsertArgsSchema: z.ZodType<Prisma.ShippingMethodUpsertArgs> = z.object({
  ...
  create: z.union([ ShippingMethodCreateInputSchema,ShippingMethodUncheckedCreateInputSchema ]),
  update: z.union([ ShippingMethodUpdateInputSchema,ShippingMethodUncheckedUpdateInputSchema ]),
}).strict() ;

export default ShippingMethodUpsertArgsSchema;
