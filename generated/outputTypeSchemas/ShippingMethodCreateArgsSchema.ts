...
export const ShippingMethodCreateArgsSchema: z.ZodType<Prisma.ShippingMethodCreateArgs> = z.object({
  select: ShippingMethodSelectSchema.optional(),
  include: z.lazy(() => ShippingMethodIncludeSchema).optional(),
  data: z.union([ ShippingMethodCreateInputSchema,ShippingMethodUncheckedCreateInputSchema ]),
}).strict() ;

export default ShippingMethodCreateArgsSchema;
